...
class Ui_MicrographMembraneSubtraction_Radonfit(object):
    def setupUi(self, MicrographMembraneSubtraction_Radonfit):
        ...
        MicrographMembraneSubtraction_Radonfit.resize(622, 372)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 60, 601, 71))
        ...
        self.output_dirname_label = QtWidgets.QLabel(self.gridLayoutWidget)
        self.output_dirname_label.setObjectName("output_dirname_label")
        self.gridLayout.addWidget(self.output_dirname_label, 1, 0, 1, 1)
        self.output_dirname_lineEdit = QtWidgets.QLineEdit(self.gridLayoutWidget)
        self.output_dirname_lineEdit.setObjectName("output_dirname_lineEdit")
        self.gridLayout.addWidget(self.output_dirname_lineEdit, 1, 1, 1, 3)
        self.line = QtWidgets.QFrame(MicrographMembraneSubtraction_Radonfit)
        self.line.setGeometry(QtCore.QRect(10, 170, 601, 16))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(MicrographMembraneSubtraction_Radonfit)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 139, 601, 32))
        ...
        self.LOG_label.setGeometry(QtCore.QRect(300, 180, 31, 16))
        self.LOG_label.setObjectName("LOG_label")
        self.LOG_textBrowser = QtWidgets.QTextBrowser(MicrographMembraneSubtraction_Radonfit)
        self.LOG_textBrowser.setGeometry(QtCore.QRect(10, 200, 601, 161))
    ...
    def retranslateUi(self, MicrographMembraneSubtraction_Radonfit):
        ...
        self.output_dirname_label.setText(_translate("MicrographMembraneSubtraction_Radonfit", "Output_dirname"))
        self.output_dirname_lineEdit.setText(_translate("MicrographMembraneSubtraction_Radonfit", "subtracted"))
